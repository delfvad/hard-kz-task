...
class ProductionInputData(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "норма процента на ссудный капитал", None))
        self.label_7.setText(_translate("Dialog", "норма налога на доход", None))
        self.label_8.setText(_translate("Dialog", "норма возмещения потребленного капитала", None))
